 ...
 */
public class JasperReportConnectionFactory {
    ...
    static {
        try {
            /*
             * Carrega a classe com.postgresl.jdbc.Driver, que é a implementação
             * do driver JDBC para o postgres.
             */
    ...
    public static Connection getPostgresConnection() throws SQLException {
        ...
        return getConnection(
                "jdbc:postgresql://localhost:5432/ArqMap",
                "postgres",
                "Djlennon2016");
