...
import cprm.gov.gileno.macedo.MODELO.TableMapaIndice;
import cprm.gov.gileno.macedo.MODELO.FotografiaAerea;
import cprm.gov.gileno.macedo.MODELO.Sessao;
import cprm.gov.gileno.macedo.MODELO.TableFotograiaAerea;
import cprm.gov.gileno.macedo.MODELO.Usuario;
import cprm.gov.gileno.macedo.MODELO.ValidaCamposComNumeros;
...
public class CadFotografiaAerea extends javax.swing.JFrame implements Serializable {
    ...
    Long idMapaIndice, idFotografiaAerea = null;
    ...
    FotografiaAerea primeiroElemento, fotografiaAerea;
    List<FotografiaAerea> listaFotografiasAereas;
    String nomeImagemSelecionada, caminhoMapaIndiceBD, caminhoImagemCapturada, caminhoPastaMapaIndicenobanco, caminhoFotografiaAereaNoBD;
    File fileDestino;
    ...
    private void initComponents() {
                ...
                .addGroup(jP_BotoesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jP_BotoesLayout.createSequentialGroup()
                        ...
                        .addGroup(jP_BotoesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(bt_imagem, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                .addContainerGap())
        );

        jP_BotoesLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {bt_imagem, jButton1, zoomImagem});
        ...
        jP_BotoesLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jP_BotoesLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(zoomImagem, javax.swing.GroupLayout.PREFERRED_SIZE, 67, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jP_BotoesLayout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {anterior, jButton1, jb_proximo, zoomImagem});
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGap(34, 34, 34)
                .addComponent(pesquisasDemapas, javax.swing.GroupLayout.DEFAULT_SIZE, 397, Short.MAX_VALUE)
                .addContainerGap())
        );
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(usuario, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 165, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void salvarFotografiaAerea() throws Exception {
        FotografiaAerea foto = new FotografiaAerea();
        ...
        foto.setIdIFotografiaAerea(idFotografiaAerea);
        foto.setImagemFotografiaAerea(caminhoPastaMapaIndicenobanco + "\\" + nomeImagemSelecionada);
        foto.setNumeroImagem(numeroInicial.getText().toUpperCase());
        foto.setLocalArmazenado(caixaLocalização.getText().toUpperCase());
        foto.setMpIndiceImagem(mapIndice);
        ...
        Set<ConstraintViolation<FotografiaAerea>> Alerta = validador.validate(foto);
        if (Alerta.size() > 0) {
            ...
            imDao.salvarFotografiaAerea(foto);
            modeloTabelaFotografiaAerea.atualizaListadeFotografiaAerea(foto);
            numeroInicial.setText("");
            caixaLocalização.setText("");
            imagemMapa.setIcon(null);
            idFotografiaAerea = null;
        }
    }

    private void removerFotografias() throws Exception {
        FotografiaAereaDao ftaDao = new FotografiaAereaDao();
        ftaDao.removeFotografiaAerea(idFotografiaAerea);
        removeFotografianoDir();
        modeloTabelaFotografiaAerea.removeFotografiaAerea(fotografiaAerea);
        modeloTabelaFotografiaAerea.atualizaListadeFotografiaAerea(fotografiaAerea);
    }

    private void removeFotografianoDir() {
        String diretorio = caminhoFotografiaAereaNoBD;
        File folder = new File(diretorio);
        folder.delete();
    }

    private void linhaSelecionadaTableFotografiaAerea() throws IOException {
        fotografiaAerea = modeloTabelaFotografiaAerea.getLinhaFotografiaAerea(tabelaFotografiaAerea.getSelectedRow());
        idMapaIndice = mapaIndice.getCod_MapaIndice();
        mapaIndice.getMapas().getCodMapa();
        numeroInicial.setText(fotografiaAerea.getNumeroImagem());
        caixaLocalização.setText(fotografiaAerea.getLocalArmazenado());
        folha.setText(String.valueOf(fotografiaAerea.getMpIndiceImagem().getFolhaFotografia()));
        escala.setText(String.valueOf(fotografiaAerea.getMpIndiceImagem().getEscala()));
        orgaoExecutor.setText(mapaIndice.getOrgaoExecutor());
        caminhoFotografiaAereaNoBD = fotografiaAerea.getImagemFotografiaAerea();
        idFotografiaAerea = fotografiaAerea.getIdIFotografiaAerea();
        exibiImagemLabelFotografiaAerea();
    ...
    private void linhaSelecionadaTableMapaIndice() throws IOException, Exception {
...
/////////////////////////////////////////// METODOS RESPONSAVEIS POR ARQUIVAR A  IMAGEM NA PASTA  /////////////////////////////////////////////////////////////////////
    private void carregaImagem() throws IOException, Exception {
        ...
        if (resultado == JFileChooser.APPROVE_OPTION) {
            ...
            imagemMapa.setIcon(redimencionaImagem2(caminhoImagemCapturada));// exibe a imagem na label (tela)
    ...
    private void exibiImagemLabelFotografiaAerea() throws IOException {
        //primeiro verifica se tem a imagem
        File file = new File(caminhoFotografiaAereaNoBD);
        bufferedImagem = ImageIO.read(file);
        imagemMapa.setIcon(redimencionaImagem(bufferedImagem));
    }

    private void exibiImagemLabelMapaIndice() throws IOException {
        //primeiro verifica se tem a imagem
        File file = new File(caminhoMapaIndiceBD);
        bufferedImagem = ImageIO.read(file);
        imagemMapa.setIcon(redimencionaImagem(bufferedImagem));
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (idFotografiaAerea == null) {
            JOptionPane.showMessageDialog(null, "Selecione  os Dados Que Deseja Excluir Clicando na Linha da Tabela");
        } else {
            int resp = JOptionPane.showConfirmDialog(null, "Deseja realmente excluir os dados da Imagem " + fotografiaAerea.getNumeroImagem()+ " ? ", null, +JOptionPane.YES_NO_OPTION);
