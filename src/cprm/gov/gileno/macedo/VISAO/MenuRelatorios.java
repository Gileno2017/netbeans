 ...
 */
public final class MenuRelatorios extends javax.swing.JFrame {
   
    /**
     * Creates new form CadUsuario
     */
    public MenuRelatorios() throws Exception {
        initComponents();
    ...
    private void sairMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_sairMouseClicked
        try {
            ...
            Logger.getLogger(MenuCad.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(MenuRelatorios.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
